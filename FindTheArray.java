...
public class FindTheArray 
{
    ...
    static void solver(InputReader in, PrintWriter pw) throws Exception 
    {
        ...
        for (int t = 1; t <= test; t++) 
        {
            ...
            else 
            {
                ...
                System.out.println("\ncontent of a ---- done after topological order\n");
    ...
    static boolean check_2(int k, int n, int b[], int order[], List<Integer> g[]) {
        ...
        System.out.println();
        System.out.println("content of l before for k = "+k);
        ...
        System.out.println();
        System.out.println("content of l for k = "+k);
        for (int i = 0; i < l.length; i++) System.out.print(l[i]+"  ");
        System.out.println();
        ...
        System.out.println();
        System.out.println("content of r after reverse\n");
    ...
    public static int[] topologicalSort(List<Integer> g[]) {
        ...
        // Indegree of every vertex is stored in ec
        System.out.println("content of ec\n");
